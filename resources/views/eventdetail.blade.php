                    ...
                    <div class="event-card mt-4">
                        ...
                        <div class="gofrnd14s">
                            <div class="gofrnd15s cursur" data-bs-toggle="modal" data-bs-target="#goWithfriendsModal">
                                <div class="gowthfrnd">
                                    <span class="gofndcunt"> {{ $data->event_user()->where('slug', 'Going')->count() }}</span>
                                    <span class="headttl5e">Going</span>
                                </div>
                                <div class="intrsdfrnd">
                                    <span class="gofndcunt">{{ $data->event_user()->where('slug', 'interested')->count() }}</span>
                                    ...
                                    <div class="pnfff145">
                                        <div class="user-info__sections">
                                            ...
                                            <ul class="invite_info__sections scroll1653 p-0">
                                                @foreach ($data->event_user as $item)
                                                @if ($item->slug == 'Going')
