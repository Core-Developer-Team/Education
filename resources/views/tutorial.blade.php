                    ...
                    <ul class="info__sections">
                        <li>
                            <a href="" class="all-info__sections">
                                ...
                                <span class="all-info__right">{{ $playlist->where('user_id', Auth()->id())->count()
                                    }}</span>
                            </a>
                        </li>
                                                    ...
                                                    <div class="posts-list">
                                                        <div class="feed-shared-product-dt">
                                                            <div class="pdct-img crse-img-tt">
                                                                <a href="">
                                                                    ...
                                                                    <div class="overlay-item">
                                                                        <div class="badge-level trnd-clr">
                                                                            free
                                                                        </div>
                                                            ...
                                                            <div class="author-dts pp-20">
                                                                <a href="" class="job-heading pp-title">{{
...
<!--Add tutorial Model-->
<div class="modal fade" id="addtutorial" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="container bg-white rounded">
                    ...
                    <form action="{{ route('tutorial.get') }}" class="form p-3" method="POST" id="tuto"
                        ...
                        <div class="form-group pt-2">
                            ...
                            <input type="text" id="playlists_id" placeholder="Paste video URL" class="form-control"
                                name="playlists_id" value="{{ old('playlists_id') }}">
