                            ...
                            <div class="posts-list">
                                <div class="feed-job-dt">
                                    ...
                                    <div class="action-btns-job job-center resmargin">
                                        ...
                                        @if ($data->reqsolutionreport->request_id == $data->id &&
                                        $data->reqsolutionreport->user_id == $data->user_id)
                            ...
                            <div class="jbdes25">
                                <div class="jobtxt47">
                                    ...
                                    <div class="pt-5">
                                        ...
                                        <div
                                            class="d-sm-flex align-items-center rounded border-none w-full mt-3 p-3 mb-4">
