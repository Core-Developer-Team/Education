    ...
    <div class="form-wrapper">
        <div class="app-form">
            ...
            <div class="app-form-content">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-10">
                            <div class="app-top-right-link text-md-end text-center mb-3">
                                Already have an account?<a class="SidebarRegister__link" href="{{ route('login') }}">Sign
                                    In</a>
                            </div>
                        </div>
                        <div class="col-lg-10 col-md-10">
                ...
                <div class="register_footer mt-60">
