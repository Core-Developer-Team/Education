                                    ...
                                    <div class="jobtxt47">
                                        ...
                                        @if (auth()->id() != $playlist->user_id)
                                            ...
                                            <form method="POST"
                                                ...
                                                action="{{ route('course.storereview') }}">
                                                @if ($errors->any())
                                                ...
                                                @endif
                                                @csrf
                                                <input type="hidden" name="course_user"
                                ...
                                @if (!$playlist->isPurchase)
                                    <div class="purchase_form_btn">
                                        <button class="buy-btn btn-hover payNow" data-id="{{ $playlist->id }}"
                                            data-amount="{{ $playlist->price }}" data-resource="cources"
                                            data-seller="{{ $playlist->user_id }}" type="submit">Buy Now</button>
                                    </div>
                                @else
                                    <div class="purchase_form_btn">
                                        <a href="javascript:void(0)">
                                            <button class="buy-btn btn-hover btn-success" type="button">Already
                                                Purchased</button>
                                        </a>
                                    </div>
                                @endif
                    ...
                    <div class="full-width mt-4">
                        <div class="user-profile">
                            ...
                            <div class="username-main-dt">
                                <a href="{{ route('profile.show', ['id' => $playlist->user_id]) }}" class="h4"
                                    style="color: {{ $playlist->user->role->color->name }}">
