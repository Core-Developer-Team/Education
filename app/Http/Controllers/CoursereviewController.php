...
class CoursereviewController extends Controller
{
    public function store(Request $request)
    {
        ...
        $pureview  = Proposalreview::where('tp_user_id', $request->course_user)->get();
        $pavguser = 0;
        $ptuserrating = 0;
        ...
        $ureview  = Review::where('t_user_id', $request->course_user)->get();
        $avguser = 0;
        $tuserrating = 0;
        $total = $ureview->count();
        ...
        $tutreview  = Playlist::where('user_id', $request->course_user)->get();
        $avgtutrat = 0;
        $trating = 0;
        ...
        $courserev  = Course::where('user_id', $request->course_user)->get();
        $avgcourse = 0;
        $courating = 0;
        ...
        $bookrev  = Book::where('user_id', $request->course_user)->get();
        $avgbook = 0;
        $bookrating = 0;
        ...
        $prodrev  = Product::where('user_id', $request->course_user)->get();
        $avgprod = 0;
        $prod = 0;
        ...
        $user = User::find($request->course_user);
        if ($user) {
        ...
        $users = User::where('id', $request->course_user)->first();
